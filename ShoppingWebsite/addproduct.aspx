...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <link href="Seller/sellerTemplate.css" rel="stylesheet" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row m-0">
            ...
            <nav class="navbar mt-2 p-2">
                <ul class="navbar-nav w-100">
                    <li class="nav-item btn">
                        <a class="" id="" href='<%=Response.ApplyAppPathModifier("Seller/SellerHomePage.aspx")%>'>
                            <i class="bi bi-house-door"></i>Sales Dashboard
                        </a>
                    </li>
                    <li class="nav-item btn">
                        <a class="" id="orders" href='<%=Response.ApplyAppPathModifier("Seller/Orders.aspx")%>'>
                            <i class="bi bi-cash-coin"></i>Orders
                        </a>
                    </li>
                    <li class="nav-item btn">
                        <a class="" id="" href='<%=Response.ApplyAppPathModifier("Seller/Products.aspx")%>'>
                            <i class="bi bi-cart3"></i>View Products
                        </a>
                    </li>
                    <li class="nav-item btn">
                        <a class="" id="" href='<%=Response.ApplyAppPathModifier("Seller/EditProducts.aspx")%>'>
                    ...
                    <li class="nav-item btn">
                        <a class="" id="" href='<%=Response.ApplyAppPathModifier("Seller/addStock.aspx")%>'>
                            <i class="bi bi-file-earmark-plus"></i>Add Stock
                        </a>
                    </li>
                    <li class="nav-item btn">
                        <a class="" id="" href='<%=Response.ApplyAppPathModifier("Seller/SellerProfile.aspx")%>' target="_blank">
        ...
        <div class="col-lg-10 col-md-9 px-0 content" style="background-color:ghostwhite;">

            <%--second top navbar--%>
            <div class="d-flex justify-content-between mb-1 bg-light mx-0 pt-3 px-3 py-2" style="color: #42A;">
                <h5><i class="fas fa-plus-circle me-1"></i> Launch New Product</h5>
                <span>
                    <button id="Button1" type="reset" class="btn-danger align-self-center" onclick="return ConfirmReset();" style="border-radius: 0.8em;"><i class="far fa-trash-alt"></i></button>
                </span>
            </div>
                                ...
                                <div class="col-12">
                                    <div id="choicesAll">
                                        <div class="form-group" id="choicesforWomen">
                                            <asp:Label CssClass="d-block" for="catType1" runat="server">Please select your category type: </asp:Label>
                                        ...
                                        <ContentTemplate>
                                            <div class="row">
                                                <div class="col-4 form-group" id="ProdSize">
                                                    <div class="w-100">
                                                        <asp:Label for="ProdSize" runat="server">Select size: </asp:Label>
                                                    </div>
                                                ...
                                                <div class="col-8">
                                                    <div class="w-100">
                                                        <asp:Label for="mrp" runat="server">Enter Stock No. for size:</asp:Label>
                                                    </div>
                                                ...
                                                <div class="col-12">
                                                    <asp:Label for="mrp" runat="server">Total Stock:</asp:Label>
                                                </div>

                                                <div class="col-12 inputs form-group">
                                                    <asp:TextBox CssClass="form-control bg-white" ID="TotalStock" runat="server" TextMode="Number" ReadOnly="true" AutoPostBack="True">0</asp:TextBox>
                                                </div>
                                            </div>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
            ...
            <div class="row mb-0">
                <div class="col-12 my-4">
                    <asp:Button CssClass="btn-danger btn-lg w-100" ID="Submit" runat="server" Text="Add Product" OnClick="Submit_Click" />
                </div>
            </div>
